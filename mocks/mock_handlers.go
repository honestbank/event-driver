...
// Source: github.com/lukecold/event-driver/handlers (interfaces: CallNext)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_handlers.go -package=mocks github.com/lukecold/event-driver/handlers CallNext
//
