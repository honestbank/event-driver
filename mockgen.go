...
//go:generate go run go.uber.org/mock/mockgen -destination=./mocks/mock_cache.go -package=mocks github.com/lukecold/event-driver/handlers/cache ConflictResolver,KeyExtractor
